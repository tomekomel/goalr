      ...
      <main v-if="isLoading" class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 xl:grid-cols-4 gap-6">
          <div class="xl:col-span-3 space-y-3">
            <div class="h-6 w-40 bg-stone-200 dark:bg-[#2d2a2a] rounded animate-pulse mb-3"></div>
            <div class="bg-stone-100/50 dark:bg-[#1a1818]/50 rounded-xl border border-stone-200/50 dark:border-[rgba(255,255,255,0.065)] p-4 space-y-4">
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                <div v-for="i in 3" :key="i" class="bg-white dark:bg-[#222020] rounded-lg p-3.5 space-y-2">
                  <div class="h-4 bg-stone-200 dark:bg-[#2d2a2a] rounded animate-pulse w-3/4"></div>
                  <div class="h-3 bg-stone-100 dark:bg-[#2d2a2a]/50 rounded animate-pulse w-1/2"></div>
                </div>
              </div>
              <div v-for="w in 2" :key="w" class="bg-white dark:bg-[#222020] rounded-lg p-3">
                <div class="h-3 bg-stone-200 dark:bg-[#2d2a2a] rounded animate-pulse w-16 mb-2"></div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                  <div v-for="j in 2" :key="j" class="bg-stone-50 dark:bg-[#222020]/50 rounded-lg p-3.5 space-y-2">
                    <div class="h-4 bg-stone-200 dark:bg-[#2d2a2a] rounded animate-pulse w-2/3"></div>
                    <div class="h-3 bg-stone-100 dark:bg-[#2d2a2a]/50 rounded animate-pulse w-1/3"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="xl:col-span-1">
            <div class="h-6 w-28 bg-stone-200 dark:bg-[#2d2a2a] rounded animate-pulse mb-3"></div>
            <div class="bg-stone-100/50 dark:bg-[#1a1818]/50 rounded-xl border border-stone-200/50 dark:border-[rgba(255,255,255,0.065)] p-3 space-y-2">
              <div v-for="i in 2" :key="i" class="bg-white dark:bg-[#222020] rounded-lg p-3.5 space-y-2">
                <div class="h-4 bg-stone-200 dark:bg-[#2d2a2a] rounded animate-pulse w-3/4"></div>
                <div class="h-3 bg-stone-100 dark:bg-[#2d2a2a]/50 rounded animate-pulse w-1/2"></div>
              </div>
            </div>
        ...
        <div class="grid grid-cols-1 gap-6" :class="showYearlyColumn ? 'xl:grid-cols-4' : 'xl:grid-cols-[1fr_auto]'">
          ...
          <div v-if="showYearlyColumn" class="xl:col-span-1 space-y-3">
              <div class="flex items-center gap-2 mb-3">
                ...
                <h2 class="text-lg font-bold text-[#222020] dark:text-[#f3ede8]">{{ t('app.yearLabel') }} <span class="text-green-500">{{ currentYearForYearly }}</span></h2>
