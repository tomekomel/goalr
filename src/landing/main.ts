...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'features.f1.desc': 'Weekly, monthly, and yearly goals — unified in one beautiful view. Drag and drop between time horizons to restructure your plans effortlessly. See the big picture and the details at the same time.',
    'features.f1.dragHint': 'drag & drop between horizons',
    'features.f1.h1': 'Unified weekly, monthly, and yearly view in one dashboard',
    'features.f1.h2': 'Drag & drop goals between time horizons instantly',
    'features.f1.h3': 'Real-time progress tracking with visual indicators',
    'features.f1.h4': 'Month and year navigation to review past and future plans',
    'features.f2.badge': 'AI-powered',
    'features.f2.title': 'AI Goal Architect',
    'features.f2.desc': 'Describe your dream in plain text. AI breaks it into actionable steps across weeks, months, and years — structured, realistic, and ready to track.',
    ...
    'features.f2.h1': 'Describe any goal in plain, everyday language',
    'features.f2.h2': 'AI generates structured, realistic action steps',
    'features.f2.h3': 'Steps organized by week, month, and year automatically',
    ...
    'features.f3.desc': 'Contextual AI coaching that adapts to your progress. Get personalized, actionable nudges that keep you moving forward — not generic motivation.',
    ...
    'features.f3.h1': 'Coaching adapts to your unique pace and style',
  ...
  pl: {
    ...
    'features.f1.desc': 'Cele tygodniowe, miesięczne i roczne — w jednym pięknym widoku. Przeciągaj i upuszczaj między horyzontami czasowymi, by swobodnie zmieniać plany. Widzisz ogólny obraz i szczegóły jednocześnie.',
    'features.f1.dragHint': 'przeciągnij i upuść między horyzontami',
    'features.f1.h1': 'Widok tygodniowy, miesięczny i roczny w jednym dashboardzie',
    'features.f1.h2': 'Przeciągaj cele między horyzontami czasowymi natychmiast',
    'features.f1.h3': 'Śledzenie postępu w czasie rzeczywistym z wizualnymi wskaźnikami',
    'features.f1.h4': 'Nawigacja po miesiącach i latach — przeglądaj przeszłe i przyszłe plany',
    'features.f2.badge': 'Napędzane AI',
    'features.f2.title': 'AI Architekt celów',
    'features.f2.desc': 'Opisz swoje marzenie prostym tekstem. AI rozbije je na konkretne kroki w tygodniach, miesiącach i latach — ustrukturyzowane, realistyczne i gotowe do śledzenia.',
    ...
    'features.f2.h1': 'Opisz dowolny cel prostym, codziennym językiem',
    'features.f2.h2': 'AI generuje ustrukturyzowane, realistyczne kroki działania',
    'features.f2.h3': 'Kroki uporządkowane wg tygodni, miesięcy i lat automatycznie',
    'features.f2.h4': 'Regeneruj lub dostosuj, aż plan będzie idealny',
    'features.f3.badge': 'Coaching',
    'features.f3.title': 'Coaching Goal Pulse',
    'features.f3.desc': 'Kontekstowy coaching AI dopasowany do Twojego postępu. Spersonalizowane, konkretne wskazówki, które pchają Cię do przodu — nie ogólnikowa motywacja.',
    ...
    'features.f3.h1': 'Coaching dopasowuje się do Twojego tempa i stylu',
    'features.f3.h2': 'Ocena ryzyka wskazuje cele wymagające uwagi',
    'features.f3.h3': 'Konkretne sugestie zamiast ogólnikowej motywacji',
