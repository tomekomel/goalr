...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'features.f2.card1': 'Week 1-4: Build base — run 3x/week, 5km',
    'features.f2.card2': 'Month 1-3: Increase to 10km, join a running club',
    'features.f2.card3': 'Year goal: Complete marathon under 4:30',
  ...
  pl: {
    ...
    'features.f2.card1': 'Tydzień 1-4: Buduj bazę — biegaj 3x/tydz., 5km',
    'features.f2.card2': 'Miesiąc 1-3: Zwiększ do 10km, dołącz do klubu',
    'features.f2.card3': 'Cel roczny: Ukończ maraton poniżej 4:30',
    'features.f3.badge': 'Coaching',
